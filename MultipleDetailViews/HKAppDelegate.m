...
#import "HKMenuView.h"
#import "MultipleDetailViews-Swift.h"
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MultipleDetailViews" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MultipleDetailViews.sqlite"];
    NSError *error = nil;
